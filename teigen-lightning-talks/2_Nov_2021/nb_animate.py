# DEAPlotting.py
"""
These functions were copied from the Digital Earth Australia dea-notebooks github repo for independent study:

This file contains aan alternate animate function branched/forked from set of python functions for plotting DEA data.
Available functions:

    nb_animate_timeseries


Last modified: during the government Trump shutdown 2019 
Authors: Claire Krause, Robbi Bishop-Taylor, Sean Chua, Mike Barnes, Cate Kooymans, Bex Dunn
Modified by: Tony Butzer
...
def nb_animated_timeseries(ds, output_path, 
